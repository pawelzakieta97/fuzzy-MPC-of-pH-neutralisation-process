...
Ysp = [0.8*ones(70,1); 0.2*ones(100,1); 0.6*ones(1,1); 1.2*ones(100,1)];
...
model_a.plot();
model_a.save_csv('../wykresy/vdv/numeric/an_simple.csv');
% 
% fc.numeric = true;
...
model_slrn_fwm.plot();
model_slrn_fwm.save_csv('../wykresy/vdv/numeric/slrnfm_simple.csv');
